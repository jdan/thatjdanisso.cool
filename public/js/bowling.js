document.addEventListener("DOMContentLoaded", function() {
    ...
    function generateThrow(game) {
        ...
        if (isNewFrame) {
            ...
            if (game.currentFrame !== 9) {
                ...
                var nextThrow = Math.floor(
                    Math.random() * (10 - lastThrow + 1))
                ...
                if (firstThrow === 10 && secondThrow === null) {
                    ...
                    var secondThrow = Math.floor(
                        Math.random() * (10 - firstThrow + 1))
                    ...
                    var thirdThrow = Math.floor(
                        Math.random() * (10 - secondThrow + 1))
    ...
    function renderScoreBoard(game) {
        ...
        for (var i = 0; i < 5; i++) {
            ...
            firstHalf.appendChild(
                renderFrame(frame.score, frame.throws, i === 9))
        }
    ...
    function renderFrame(score, throws, isTenth) {
        ...
        if (isTenth) {
            ...
            // X[normal frame]
                ...
                contents = [throwToString(10)].concat(
                    frameToString(throws.slice(1)))
    ...
    function renderGraph(graphDiv) {
        ...
        for (var i = 0; i <= 300; i++) {
            ...
            bar.style.height =
                (scores[i] || 0) / highestPopulation * 100 + "%"
    ...
    function renderStats(statsDiv) {
        ...
        if (allGames.length % 2 === 1) {
            ...
            median = (
                ...
                allGames[Math.floor(allGames.length / 2) - 1]) / 2
        }
        ...
        statsDiv.innerHTML = "<div>" + [
            ...
            '<span class="stats-label">Mode:</span><span> ' + modeIndex + ' (' + mode + ' games)</span>',
        ].join("</div><div>") + "</div>"
    }
